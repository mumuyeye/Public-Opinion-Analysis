...
from utils import extract_items, get_tokenizer, metric, save_model, load_model
import os, argparse
...
if __name__ == '__main__':
    ...
    # save_model(subject_model, "./ckpts/" + "subject_model" + ".pkl")
    # save_model(object_model, "./ckpts/" + "object_model" + ".pkl")
    # save_model(hbt_model, "./ckpts/" + "hbt_model" + ".pkl")
