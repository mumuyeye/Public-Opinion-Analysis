...
def train():
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        # Evaluate and print confusion matrix for the test set
        y_true, y_pred = evaluate(sess, model, "test", test_manager, id_to_tag, logger)

        # Generate confusion matrix
        conf_mat = confusion_matrix(y_true, y_pred, labels=list(id_to_tag.values()))

        # Plot confusion matrix
        plt.figure(figsize=(len(id_to_tag), len(id_to_tag)))
        sns.heatmap(conf_mat, annot=True, fmt="d", cmap="Blues",
                    xticklabels=list(id_to_tag.keys()), yticklabels=list(id_to_tag.keys()))
